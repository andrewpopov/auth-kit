...
export interface SingleUseTokenStore {
     ...
     */
    consume(tokenHash: string, options: {
        purpose: string;
        now: Date;
    }): Promise<ConsumeTokenStoreResult>;
    /**
...
export declare function issueSingleUseToken(store: SingleUseTokenStore, options: {
    purpose: string;
    subjectId: string;
    ttlMs: number;
    now?: Date;
 ...
 */
export declare function createMemorySingleUseTokenStore(): SingleUseTokenStore;
